...
import { addReminder, clearReminders, deleteReminder } from '../actions/index.js';
...
export default connect(mapStateToProps, { addReminder, clearReminders, deleteReminder })(App);
